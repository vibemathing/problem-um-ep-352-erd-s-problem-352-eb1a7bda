...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-352-erd-s-problem-352-eb1a7bda-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-352"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-352-erd-s-problem-352-eb1a7bda-v1",
      "problem_contract_sha256": "e0de23b729582c277382850340164a6dc4ac6fecfdcc977b8721814123910583",
      "problem_id": "problem:um-ep-352-erd-s-problem-352-eb1a7bda",
      "route_id": "route:um-ep-352-erd-s-problem-352-eb1a7bda-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-352-erd-s-problem-352-eb1a7bda-source-fidelity-01",
      "graph_id": "graph:um-ep-352-erd-s-problem-352-eb1a7bda-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-352-erd-s-problem-352-eb1a7bda-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-352-erd-s-problem-352-eb1a7bda-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is there some $c>0$ such that every measurable $A\\subseteq \\mathbb{R}^2$ of measure $\\geq c$ contains the vertices of a triangle of area 1?"
          },
          "statement_sha256": "9752852f911d916708e079a5678500e101f23cfa69c02237c8faa00c5d5eefcd"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-352-erd-s-problem-352-eb1a7bda-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-352-erd-s-problem-352-eb1a7bda-root",
      "route_id": "route:um-ep-352-erd-s-problem-352-eb1a7bda-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-352-41fd3b034522",
        "url": "https://www.unsolvedmath.com/problems/EP-352"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
